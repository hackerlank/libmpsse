...
class context(_object):
    ...
    __swig_setmethods__["interface1"] = _ftdi1.context_interface1_set
    __swig_getmethods__["interface1"] = _ftdi1.context_interface1_get
    if _newclass:interface1 = _swig_property(_ftdi1.context_interface1_get, _ftdi1.context_interface1_set)
...
def set_interface(*args):
  """set_interface(context ftdi, enum ftdi_interface interface1) -> int"""
...
def write_data(*args):
  """write_data(context ftdi, unsigned char * buf, int size) -> int"""
